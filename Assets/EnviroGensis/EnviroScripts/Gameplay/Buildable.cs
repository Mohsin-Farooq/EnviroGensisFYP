...
namespace EnviroGenesis
{
    ...
    public class Buildable : MonoBehaviour
    {
        ...
        public bool CheckIfOverlap()
        {
            ...
            foreach (Collider collide in colliders) {
                Collider[] over = Physics.OverlapBox(collide.bounds.center, collide.bounds.extents, Quaternion.identity, olayer);
        ...
        {
            return build_distance + character.Crafting.build_range;
        }
