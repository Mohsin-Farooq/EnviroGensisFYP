                ...
                if(spriteRenderer.sprite == back)
                {
                    ...
                    if(!gameController.GetComponent<GameController>().TwoCardsUp())
                    {
                        ...
                        if(gameController.GetComponent<GameController>().firstCard == null)
                            ...
                            gameController.GetComponent<GameController>().AddFrontFace(frontIndex, this.gameObject);     
                        ...
                        {
                            //gameController.GetComponent<GameController>().firstCard.gameObject.SetActive(false);
                            //gameController.GetComponent<GameController>().secondCard.gameObject.SetActive(false);
                            //TimeDelay(0.5f);
