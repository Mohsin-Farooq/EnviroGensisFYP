...
public class GameManager : MonoBehaviour {
    ...
    public void LoadQuestions(string question)
    {
        ...
        if(question == "Ecosystems & Habitats")
        {
             objs = Resources.LoadAll("Ecosystems & Habitats", typeof(Question));
        }
        if(question == "Green Buildings & Sustainable Architecture")
        {
             objs = Resources.LoadAll("Green Buildings & Sustainable Architecture", typeof(Question));
        }
        if(question == "Planting & Gardening")
        {
             objs = Resources.LoadAll("Planting & Gardening", typeof(Question));
        } 
        if(question == "Pollution Awareness")
        {
             objs = Resources.LoadAll("Pollution Awareness", typeof(Question));
        } 
        if(question == "Recycling & Waste Management")
        {
             objs = Resources.LoadAll("Recycling & Waste Management", typeof(Question));
        } 
        if(question == "Renewable & Non-Renewable Energy")
        {
             objs = Resources.LoadAll("Renewable & Non-Renewable Energy", typeof(Question));
        } 
        if(question == "Sustainable Agriculture & Food Systems")
        {
             objs = Resources.LoadAll("Sustainable Agriculture & Food Systems", typeof(Question));
        } 
        if(question == "Sustainable Transportation")
        {
             objs = Resources.LoadAll("Sustainable Transportation", typeof(Question));
        } 
        if(question == "Water Conservation")
        {
             objs = Resources.LoadAll("Water Conservation", typeof(Question));
        }
